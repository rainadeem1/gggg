var site_settings = '<div class="ts-button">'
    ...
    +'<div class="ts-body">'
        ...
        +'<div class="ts-themes">'
            + '<a href="#" class="active" data-theme="css/theme-default.css"><img src="/Content/img/themes/default.jpg"/></a>'
            + '<a href="#" data-theme="css/theme-forest.css"><img src="/Content/img/themes/forest.jpg"/></a>'
            + '<a href="#" data-theme="css/theme-dark.css"><img src="/Content/img/themes/dark.jpg"/></a>'
            + '<a href="#" data-theme="css/theme-night.css"><img src="~/Content/img/themes/night.jpg"/></a>'
            + '<a href="#" data-theme="css/theme-serenity.css"><img src="~/Content/img/themes/serenity.jpg"/></a>'
            
            + '<a href="#" data-theme="css/theme-default-head-light.css"><img src="~/Content/img/themes/default-head-light.jpg"/></a>'
            + '<a href="#" data-theme="css/theme-forest-head-light.css"><img src="~/Content/img/themes/forest-head-light.jpg"/></a>'
            + '<a href="#" data-theme="css/theme-dark-head-light.css"><img src="~/Content/img/themes/dark-head-light.jpg"/></a>'
            + '<a href="#" data-theme="css/theme-night-head-light.css"><img src="~/Content/img/themes/night-head-light.jpg"/></a>'
            + '<a href="#" data-theme="css/theme-serenity-head-light.css"><img src="~/Content/img/themes/serenity-head-light.jpg"/></a>'
